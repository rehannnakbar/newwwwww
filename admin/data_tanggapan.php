               ...
               <div class="card-body">
                <table class="table table-striped">
                    ...
                    include '../config/koneksi.php';
                        $no = 1;
                        $query = mysqli_query($koneksi, "SELECT a.*,b.* FROM tanggapan a INNER JOIN tanggapan  b ON a.id_pengaduan=b.id_pengaduan");
                    ...
                    <div class="modal-dialog"> 
                        ...
                        <form action="edit_data.php" method="POST">
                           ...
                           <p>apakah anda yakin akan menghapus tanggapan <br><?php  echo $data['judul_laporan'] ?></p>
                            ...
                            <button type="submit" name="hapus_tanggapan" class="btn btn-primary">HAPUS</button>
                        </div>
                        </form>
