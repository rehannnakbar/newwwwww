                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="../assets/img/<?php echo $data ['foto'] ?>" height="100"></td>
                            <td>
                            <?php
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-footer">
                                <button type="submit" name="kirim" class="btn btn-danger">VERIFIKASI</button>
                            </div>
                            </form>
                     ...
                     <a href="" class="btn btn-secondary"data-bs-toggle="modal" data-bs-target="#tanggapi<?php echo $data['id_pengaduan']?>">TANGGAPI</a>
                    ...
                    <div class="modal-dialog"> 
                        ...
                        <div class="modal-footer">
                            <button type="submit" name="kirim" class="btn btn-danger">TANGGAPI</button>
                        </div>
                        </form>
                    ...
                    <div class="modal-dialog"> 
                        ...
                        <div class="modal-body">
                        <form action="delete.php?id_pengaduan=<?= $data['id_pengaduan'] ?>" method="POST">
                            <input type="hidden" name="id_pengaduan" class="form-control" value="<?php echo $data['id_pengaduan']?>">
